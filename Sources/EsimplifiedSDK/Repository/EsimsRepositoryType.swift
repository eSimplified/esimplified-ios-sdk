...
public protocol EsimsRepositoryType {
    func fetchEsims(archivedEsims: Bool, showLegacy: Bool?, isPrimary: Bool?, includeBase64QrCode: Bool, forceRefresh: Bool, cacheTTL: TimeInterval) async -> [Esim]
...
public extension EsimsRepositoryType {
    ...
    func fetchEsims(
        ...
        showLegacy: Bool? = nil,
        isPrimary: Bool? = nil,
        includeBase64QrCode: Bool = false,
...
public extension EsimsRepositoryType {
    ...
    func fetchEsimDetailsResult(
        ...
        RepositoryResult(value: await fetchEsimDetails(
            iccid: iccid,
            includeBase64QrCode: includeBase64QrCode,
            forceRefresh: forceRefresh,
            cacheTTL: cacheTTL
